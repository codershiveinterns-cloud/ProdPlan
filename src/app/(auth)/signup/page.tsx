  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Set up your plant in a minute. You will be the first admin and can invite your team from Settings.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <SignupForm timezones={timezones} defaultTimezone={DEFAULT_TIMEZONE} />
      </CardContent>
