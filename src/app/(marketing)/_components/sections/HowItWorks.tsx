...
export function HowItWorks() {
  return (
    <Section id="how-it-works" aria-labelledby="how-title" className="border-y border-slate-200 bg-white">
      <Container>
        <SectionHeader
          id="how-title"
        ...
        <ol className="relative mt-12 grid gap-10 lg:mt-16 lg:grid-cols-4 lg:gap-8">
          <div
            aria-hidden="true"
            className="absolute top-0 bottom-0 left-5 w-px bg-slate-200 lg:top-5 lg:right-[12.5%] lg:bottom-auto lg:left-[12.5%] lg:h-px lg:w-auto"
          />
          {STEPS.map((step, i) => (
            <li key={step.title} className="relative flex gap-5 lg:flex-col lg:items-center lg:gap-5 lg:text-center">
              ...
              <div className="pt-1.5 lg:pt-0">
                ...
                <p className="mt-2 text-base leading-relaxed text-pretty text-slate-600">{step.copy}</p>
              </div>
            </li>
          ))}
        </ol>
