    ...
    <MockSnippet caption="Illustration of a material detail page: 64.500 kg on hand, flagged below its 80 kg reorder threshold, and a ledger of receipts and issues with the balance after each movement.">
      <div className="grid gap-2.5 @md:grid-cols-[minmax(0,11rem)_1fr]">
        <MockCard className="p-3">
          ...
          <div className="mt-0.5 truncate text-[11px] text-stone-500">Aluminium bar 6061</div>
          <div className="mt-2 text-[11px] font-medium text-stone-500">Stock on hand</div>
          ...
          <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
            ...
            <span className="text-[10px] text-stone-500">Reorder at 80.000 kg</span>
          </div>
        </MockCard>

        <MockCard>
          <div className="flex items-center justify-between px-3 pt-2.5 pb-1.5">
            <span className="text-[12px] font-semibold text-foreground">Stock ledger</span>
            <span className="inline-flex h-6 items-center rounded-md border border-stone-300 bg-white px-2 text-[10px] font-medium text-stone-700">
              Record movement
            </span>
          </div>
          <MockTable
          ...
          >
            <tr>
              <td className="text-stone-500">06 Sep 15:40</td>
              <td>Issue</td>
              <td className="text-right font-medium text-red-700">−18.500 kg</td>
              <td className="hidden text-right text-foreground @sm:table-cell">64.500 kg</td>
              <td className="hidden @md:table-cell">
                <Code className="text-[11px]">SO-000118</Code>
              </td>
            </tr>
            <tr>
              <td className="text-stone-500">05 Sep 09:12</td>
              <td>Receipt</td>
              <td className="text-right font-medium text-green-700">+40.000 kg</td>
              <td className="hidden text-right text-foreground @sm:table-cell">83.000 kg</td>
              <td className="hidden @md:table-cell">
                <Code className="text-[11px]">PO-4471</Code>
              </td>
            </tr>
            <tr>
              <td className="text-stone-500">02 Sep 11:05</td>
              <td>Adjustment</td>
              <td className="text-right font-medium text-red-700">−1.250 kg</td>
              <td className="hidden text-right text-foreground @sm:table-cell">43.000 kg</td>
              <td className="hidden text-stone-500 @md:table-cell">Count</td>
            </tr>
          </MockTable>
        </MockCard>
      </div>
